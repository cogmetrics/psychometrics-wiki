...
## Toxins and Drugs
Bruce Lanphear published a perspective article in 2017 with the title "Low-Level Toxicity of Chemicals: No Acceptable Levels?"[^low_level_toxicity]. The key message was that societies need to achieve zero exposure to chemicals such as lead, radon, airborne particles, asbestos, and benzene because "**the amount of toxic chemical linked with the development of a disease is proportionately greater at the lowest dose or levels of exposure**". The next figure [tk] below depicts this visually with respect to blood lead levels and IQ scores.
