...
Figure x.x depicts the function relating blood lead levels and IQ scores and the sobering main conclusion: "An increase in blood lead from &lt;1 µ/dL to 30 µ/dL was associated with a 9.2 IQ deficit, but the largest fraction of this deficit (6.2 IQ points) occurred below 10 µ/dL. … Despite the dramatic decline in blood lead levels, lead exposure accounts for a loss of 32 million IQ points in a 6-year birth cohort of US children" (p. 3).
