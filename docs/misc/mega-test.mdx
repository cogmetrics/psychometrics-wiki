...
The Mega Test, devised by amateur psychometrician Ronald K. Hoeflin[^hoeflin] and first published in Omni magazine in 1985, is an untimed, self-administered "high-range" IQ test. The Mega Test was intended to discriminate among individuals already scoring at the extreme right tail of IQ. 
...
Although Mega Test results are still recognized by a handful of high IQ societies, the test is no longer actively administered, and its small, non-representative sample means its reliability, g-loading, and predictive validity have never been demonstrated in peer-reviewed research.
...
Taken together, the Mega Test's norms rest on a statistical house of cards built from a narrow sample and further multiplied through rounds of self-referencial norming.

### Reliability & Validity

no proctored retest data, shaky correlations with WAIS/RAPM/SAT.

### Statistical Inflation

why you can't safely extrapolate to "IQ 190+" with N ≈ 30.
