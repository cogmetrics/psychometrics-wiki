...
<img src={useBaseUrl('/img/document/XNp2jR2.jpeg')} alt="heritability with age" className="center-img" />
<p className="under-image">Heritability with Age (Wilson Effect)</p>

By **late adolescence or early adulthood**, heritability is at its highest, and your measured IQ tends to stabilize.  

<img src={useBaseUrl('/img/document/qMSOljv.jpeg')} alt="aging and iq" className="center-img" />
<p className="under-image">The effect of aging on various cognitive factors</p>
...
<img src={useBaseUrl('/img/document/iGPagcw.png')} alt="iq variance by age" className="center-img" />
<p className="under-image">Decomposition of the variance in FSIQ over time</p>
