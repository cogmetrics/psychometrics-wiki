...
<img src={useBaseUrl('/img/document/wilson1.jpeg')} alt="heritability with age" className="center-img" />
...
<img src={useBaseUrl('/img/document/age_decline.jpeg')} alt="aging and iq" className="center-img" />
...
<img src={useBaseUrl('/img/document/heritability.png')} alt="iq variance by age" className="center-img" />
